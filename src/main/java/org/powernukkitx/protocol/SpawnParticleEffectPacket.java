...
import org.powernukkitx.protocol.types.DimensionIdEnum;
import org.powernukkitx.protocol.types.SpawnParticleEffectPacket_Dimension_IdEnum;
import org.powernukkitx.protocol.types.Vec3;

@Getter
@Setter
public class SpawnParticleEffectPacket implements IPacket {
  private SpawnParticleEffectPacket_Dimension_IdEnum dimensionId;
