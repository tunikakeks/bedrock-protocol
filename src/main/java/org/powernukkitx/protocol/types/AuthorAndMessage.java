...
public class AuthorAndMessage {
  ...
  public void encode(ByteBuf buf) {
    buf.writeInt(chat.ordinal());
    buf.writeInt(whisper.ordinal());
    buf.writeInt(announcement.ordinal());
  ...
  public void decode(ByteBuf buf) {
    chat = ChatEnum.values()[buf.readInt()];
    whisper = WhisperEnum.values()[buf.readInt()];
    announcement = AnnouncementEnum.values()[buf.readInt()];
