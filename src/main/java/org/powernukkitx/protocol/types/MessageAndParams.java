...
public class MessageAndParams {
  ...
  public void encode(ByteBuf buf) {
    buf.writeInt(translate.ordinal());
    buf.writeInt(popup.ordinal());
    buf.writeInt(jukeboxpopup.ordinal());
  ...
  public void decode(ByteBuf buf) {
    translate = TranslateEnum.values()[buf.readInt()];
    popup = PopupEnum.values()[buf.readInt()];
    jukeboxpopup = JukeboxpopupEnum.values()[buf.readInt()];
