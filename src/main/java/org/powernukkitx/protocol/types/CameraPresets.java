...
public class CameraPresets {
  ...
  public void encode(ByteBuf buf) {
    ...
    buf.writeInt(listener.ordinal());
    buf.writeBoolean(playerEffects);
    aimAssist.encode(buf);
    buf.writeInt(controlScheme.ordinal());
  }
  ...
  public void decode(ByteBuf buf) {
    ...
    listener = ListenerEnum.values()[buf.readInt()];
    playerEffects = buf.readBoolean();
    aimAssist = new _950654229();
    aimAssist.decode(buf);
    controlScheme = ControlSchemeEnum.values()[buf.readInt()];
  }
}
