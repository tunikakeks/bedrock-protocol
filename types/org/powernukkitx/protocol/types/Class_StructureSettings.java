...
public class Class_StructureSettings {
  ...
  public void encode(ByteBuf buf) {
    ...
    buf.writeByte(mirror.toByte());
    buf.writeByte(animationMode.toByte());
  ...
  public void decode(ByteBuf buf) {
    ...
    mirror = MirrorEnum.fromByte(buf.readUnsignedByte());
    animationMode = AnimationModeEnum.fromByte(buf.readUnsignedByte());
